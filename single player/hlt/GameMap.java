...
public class GameMap {
    ...
    public ArrayList<Entity> objectsBetween(Position start, Position target, ArrayList<Move> currentMoves) {
        ...
        if (Collision.collisionInTransit(start, target, currentMoves)) {
        	entitiesFound.add(Collision.getCollisionShipInTransit(start, target, currentMoves));
        }
